              ...
              <div key={item.id} className="flex gap-3 max-w-full">
                ...
                <div className="flex flex-col w-full text-ellipsis">
                  <div className="flex justify-between items-center w-full">
                    ...
                    <span className="font-semibold text-neutral-500 text-sm">Ordered At {format(item.createdAt, "MM/dd/yyyy")}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    ...
                    <div className="flex gap-2 items-center">
                      ...
                      <span className={`${status[item.status]} rounded-sm px-2 py-1 font-semibold`}>{item.status}</span>
                    </div>
                  </div>
                </div>
              </div>
